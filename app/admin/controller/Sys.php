...
class Sys extends Base
{
    ...
    public function runsys()
    {
        if (!request()->isAjax()) {
            ...
            //水印图片
            $options['site_water'] = input('oldcheckpicname_1');
     ...
     */
    public
    function restore($time = 0, $part = null, $start = null)
    {
        //读取备份配置
        $config = array(
     ...
     */
    public
    function export($tables = null, $id = null, $start = null)
    {
