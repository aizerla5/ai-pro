...
$configs = [
    ...
    'dispatch_error_tmpl' => ROOT_PATH . 'public/pages/dispatch_jump.html',
    ...
    // 异常页面的模板文件
    'exception_tmpl' => ROOT_PATH . 'public/pages/error.html',

    // 错误显示信息,非调试模式有效
    'error_message' => 'Page errors! Please try again later',
    // 显示错误信息
